...
formatted_data = json.dumps(odds_response, indent=4)  # Formats json into a much more readible response
...
class Event:
    ...
    def find_best_odds(self):
        ...
        num_outcomes = len(self.data['bookmakers'][FIRST]['markets'][FIRST][
                               'outcomes'])  # Goes into each event on each bookeeper and gets the count of unqiue events
